...
public class PluginBinderContractTest {
    @Test(timeout = 180000) public void discoveryMetadataInferenceInvalidInputAndRebind() throws Exception {
        ...
        Intent discovery = new Intent("org.autojs.plugin.MLKIT_BARCODE").addCategory("mlkit-barcode").setPackage(context.getPackageName());
        ...
        for (int repetition = 0; repetition < 2; repetition++) {
            ...
            try {
                ...
                assertEquals("org.autojs.plugin.mlkit.barcode.api.IBarcodePlugin", binder.getInterfaceDescriptor());
                ...
                IBarcodePlugin plugin = IBarcodePlugin.Stub.asInterface(transport);
