# AutoJs6-Plugin-MLKit-Barcode: repository rules
...
- Root project name is `autojs6-plugin-mlkit-barcode`. Use the publicly published platform-versions and native-alignment plugins at 1.8.3; no local plugin override, mavenLocal, consumer gradle/data, or sibling JAR/AAR dependency.
...
- Services: .MlKitBarcodePluginService. Discovery actions: org.autojs.plugin.MLKIT_BARCODE. Preserve their existing public action/category/AIDL contracts and host capability negotiation.
