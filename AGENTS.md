...
- Root project name is `autojs6-plugin-mlkit-barcode`. Use the publicly published platform-versions and native-alignment plugins at 1.8.1; no local plugin override, mavenLocal, consumer gradle/data, or sibling JAR/AAR dependency.
